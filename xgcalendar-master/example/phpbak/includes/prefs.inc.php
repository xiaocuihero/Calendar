<?php
define("TIMEZONE_INDEX",'Asia/Shanghai');
define("WEEK_START",1);
...
function GetCalendarViewFormat($viewType, $showdate)
{
	...
	{ 
		...
		case "month": // 月         
			...
			if ( date("Y",$ret["end_date"] ) == date("Y", $showday1) && date("m",$ret["end_date"] ) == date("m", $showday1) && date("m",$ret["end_date"]+mktime(0,0,0,0,1,0)) == date("m",$ret["end_date"]))
			{
